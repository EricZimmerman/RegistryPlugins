...
namespace RegistryPlugin.Services
{
    public class Service:IValueOut
    {
        ...
        public string BatchValueData2 => $"Name last write: {NameKeyLastWrite.ToUniversalTime():yyyy-MM-dd HH:mm:ss.fffffff}, Parameters last write: {ParametersKeyLastWrite?.ToUniversalTime():yyyy-MM-dd HH:mm:ss.fffffff}";
        public string BatchValueData3 => $"Image path: {ImagePath} ServiceDLL: {ServiceDLL}";
    }
}
