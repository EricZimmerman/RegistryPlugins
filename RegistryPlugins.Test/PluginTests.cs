...
using ValuesOut = RegistryPlugin.USBSTOR.ValuesOut;
...
public class PluginTests
{
    ...
    public void BlakeOpenSavePidlMRU()
    {
        ...
        var reg = new RegistryHive(@"C:\temp\NTUSER.DAT_clean");
        reg.ParseHive();
    ...
    public void BlakeServices()
    {
        ...
        Check.That(ff.StartMode).IsEqualTo(Service.ServiceStartMode.Manual);
        Check.That(ff.ServiceType).IsEqualTo(Service.ServiceTypeEnum.Win32ShareProcess);
