...
namespace RegistryPlugin.SWD
{
    ...
    {
        public ValuesOut(string type, string keyName, string deviceDesc, string friendlyName, DateTimeOffset? installed, DateTimeOffset? firstinstalled, DateTimeOffset? lastconnected, DateTimeOffset? lastremoved)
        {
            Type = type;
            KeyName = keyName;
        ...
        public string BatchValueData1 => $"Type: {Type} KeyName: {KeyName}";
